...
@keyframes pulse {
  ...
  .direccion-tag { font-size: 11px; letter-spacing: 5px; text-transform: uppercase; color: var(--rojo); display: block; margin-bottom: 12px; }
  .direccion-title { font-family: 'Bebas Neue', sans-serif; font-size: clamp(40px, 5vw, 64px); line-height: 1; letter-spacing: 2px; margin-bottom: 32px; }
  .direccion-item { display: flex; align-items: flex-start; gap: 16px; margin-bottom: 20px; }
  .direccion-icon { color: var(--rojo); font-size: 16px; margin-top: 2px; flex-shrink: 0; }
  .direccion-label { font-size: 10px; letter-spacing: 3px; text-transform: uppercase; color: var(--gris); margin-bottom: 4px; }
  .direccion-valor { font-size: 14px; color: var(--blanco); font-weight: 300; letter-spacing: 1px; line-height: 1.5; }
  .direccion-mapa { width: 100%; aspect-ratio: 4/3; border: 1px solid rgba(255,255,255,0.06); filter: grayscale(1) contrast(1.1) brightness(0.7); transition: filter 0.4s; }
      ...
      {vista === 'home' && (
        <section className="direccion-section">
          <div>
            ...
            <h2 className="direccion-title">DÓNDE<br />ESTAMOS</h2>
            <div className="direccion-item">
              <span className="direccion-icon">📍</span>
              <div>
                <div className="direccion-label">Dirección</div>
                <div className="direccion-valor">La Fama Barbershop All-Star<br />Medellín, Colombia</div>
              </div>
            </div>
            <div className="direccion-item">
              <span className="direccion-icon">🕐</span>
              <div>
                ...
                <div className="direccion-valor">Lun – Sáb · 8:00am – 8:00pm<br />Dom · 9:00am – 4:00pm</div>
              </div>
            </div>
            <div className="direccion-item">
              <span className="direccion-icon">📞</span>
              <div>
                ...
                <div className="direccion-valor">+57 318 345 3071</div>
              </div>
            </div>
          </div>
          {/* 👇 Reemplaza el src del iframe con el embed de Google Maps de tu local */}
          <iframe
            className="direccion-mapa"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966!2d-75.5706!3d6.2086!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zTGEgRmFtYSBCYXJiZXI!5e0!3m2!1ses!2sco!4v1"
            allowFullScreen=""
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            title="La Fama Barbershop All-Star"
          />
        </section>
      )}
